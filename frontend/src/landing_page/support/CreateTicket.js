...
function CreateTicket() {
    return ( 
      ...
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
          <i class="fa fa-user" aria-hidden="true"></i> Your MarketMinds Account
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Login Credentials
          </a>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
          <i class="fa fa-bar-chart" aria-hidden="true"></i> Your MarketMinds Account
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Margin/leverage, Product and Order Tapes
          </a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Kite Web and Mobile
